  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="text-xs text-gray-500 text-center animate-slide-up-fade delay-400 fill-mode-forwards opacity-0 px-2 pt-2">
        ...
        <Link href="/terms-of-use" className="text-primary hover:text-white underline transition-colors">
          ข้อตกลงการใช้งาน
        </Link>{' '}
        และ{' '}
        <Link href="/privacy-policy" className="text-primary hover:text-white underline transition-colors">
