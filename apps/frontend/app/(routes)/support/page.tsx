    ...
    <div className="pt-24 pb-20 px-4 min-h-screen animate-fade-in">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
          Chronos เป็นแพลตฟอร์มอิสระ
          การสนับสนุนของคุณช่วยให้เราสร้างสรรค์วิดีโอแบบ Interactive คุณภาพสูง
          ดูแลเซิร์ฟเวอร์ และพัฒนาฟีเจอร์ใหม่ๆ ต่อไป
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            },
            {
              icon: Server,
              title: "โฮสติ้ง",
              desc: "เซิร์ฟเวอร์สตรีมมิ่งวิดีโอความเร็วสูง",
            },
            {
              icon: Code,
              title: "พัฒนา",
              desc: "ฟีเจอร์แพลตฟอร์มและการแก้ไขบั๊ก",
            },
            {
              icon: Sparkles,
              title: "AI",
              desc: "พัฒนาความสามารถของเทพพยากรณ์และระบบเล่าเรื่อง",
            },
          ].map((item, i) => (
            <div
              key={i}
