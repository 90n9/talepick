    ...
    <div className="min-h-screen px-4 pb-20 pt-24 animate-fade-in">
      <div className="mx-auto max-w-4xl">
        <div className="mb-16 text-center">
          ...
          <h1 className="mb-4 text-4xl font-serif font-bold text-white md:text-5xl">ข้อตกลงการใช้งาน</h1>
        ...
        <div className="space-y-12 rounded-2xl border border-white/10 bg-surface/30 p-8 shadow-2xl backdrop-blur-md md:p-12">
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-gray-300">
              ยินดีต้อนรับสู่ {APP_NAME} (&ldquo;แพลตฟอร์ม&rdquo;) การเข้าถึงหรือใช้งานแพลตฟอร์มของเรา แสดงว่าคุณยอมรับและตกลงที่จะปฏิบัติตามข้อกำหนดและเงื่อนไขเหล่านี้ หากคุณไม่เห็นด้วยกับส่วนหนึ่งส่วนใดของข้อกำหนด กรุณาหยุดใช้งานแพลตฟอร์มทันที
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="leading-relaxed text-gray-300">
              {APP_NAME} ให้บริการในลักษณะ &ldquo;ตามที่เป็นอยู่&rdquo; (As is) เราไม่รับประกันว่าแพลตฟอร์มจะปราศจากข้อผิดพลาด หรือจะเปิดให้บริการตลอดเวลา เราจะไม่รับผิดชอบต่อความเสียหายใดๆ ที่เกิดจากการใช้งานหรือความไม่สามารถใช้งานแพลตฟอร์มได้
            </p>
          </section>
