...
export default function AuthLayout({ children, title, subtitle, onClose }: AuthLayoutProps) {
    ...
    <div className='relative flex min-h-screen items-center justify-center overflow-hidden bg-black text-white py-12 md:py-16'>
      ...
      <div className='relative z-10 w-full max-w-md px-6'>
        <div className='mb-10 text-center'>
          <Link
            href='/'
            className='inline-block text-3xl font-semibold tracking-wide text-white drop-shadow transition hover:text-primary'
          >
            {APP_NAME}
          </Link>
        </div>
