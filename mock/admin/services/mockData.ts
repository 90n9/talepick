...
export const MOCK_GENRES: Genre[] = [
  {
    ...
    name: 'ผจญภัย',
    slug: 'adventure',
    description: 'การเดินทางสำรวจดินแดนลึกลับและไขปริศนา',
    storyCount: 15,
    isActive: true,
  },
  {
    ...
    name: 'แฟนตาซี',
    slug: 'fantasy',
    description: 'โลกแห่งเวทมนตร์ สัตว์ในตำนาน และพลังเหนือธรรมชาติ',
    storyCount: 24,
    isActive: true,
  },
  {
    ...
    name: 'ไซเบอร์พังค์',
    slug: 'cyberpunk',
    description: 'โลกอนาคตที่เทคโนโลยีล้ำหน้าแต่สังคมเสื่อมโทรม',
    storyCount: 8,
    isActive: true,
  },
  {
    ...
    name: 'สยองขวัญ',
    slug: 'horror',
    description: 'เรื่องราวที่น่าสะพรึงกลัวและชวนขนหัวลุก',
    storyCount: 10,
    isActive: true,
  },
  {
    ...
    name: 'รักโรแมนติก',
    slug: 'romance',
    description: 'ความรักความสัมพันธ์ที่อบอุ่นหัวใจหรือดราม่า',
    storyCount: 32,
    isActive: true,
  },
  {
    ...
    name: 'สืบสวน',
    slug: 'mystery',
    description: 'การไขคดีฆาตกรรมและการหาความจริง',
    storyCount: 12,
    isActive: true,
  },
  {
    ...
    name: 'ดราม่า',
    slug: 'drama',
    description: 'เรื่องราวสะเทือนอารมณ์และชีวิตจริง',
    storyCount: 5,
    isActive: false,
  },
];
...
export const MOCK_ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'a7',
    title: 'นักอ่านยามดึก',
    description: 'เล่นนิยายในช่วงเวลา 00:00 - 04:00',
    type: AchievementType.AUTO,
    icon: 'zap',
    isActive: true,
    rewardCredits: 20,
  ...
  {
    id: 'a8',
    title: 'แฟนพันธุ์แท้ไซไฟ',
    description: 'เล่นนิยายแนวไซเบอร์พังค์ครบ 3 เรื่อง',
    type: AchievementType.AUTO,
    icon: 'star',
    isActive: true,
    rewardCredits: 100,
  ...
  {
    id: 'a9',
    title: 'ผู้บริจาคระดับทอง',
    description: 'สนับสนุนเว็บไซต์รวม 1000 บาท',
    type: AchievementType.MANUAL,
    icon: 'shield',
    isActive: true,
    rewardCredits: 1000,
    rewardMaxCredits: 100,
    usersUnlocked: 10,
    unlockTrend: 0,
  },
  {
    id: 'a10',
    title: 'นักสืบฝึกหัด',
    description: 'ไขคดีสำเร็จในนิยายสืบสวน 1 เรื่อง',
    type: AchievementType.AUTO,
    icon: 'compass',
    isActive: true,
    rewardCredits: 50,
...
export const MOCK_USERS: User[] = [
    ...
    activityLogs: [
      {
        id: 'l1',
        action: 'เข้าสู่ระบบ',
        details: 'เข้าใช้งานผ่าน Email',
        timestamp: '2023-10-25T14:30:00Z',
      },
      {
        id: 'l2',
        action: 'เติมเงิน',
        details: 'ซื้อแพ็คเกจ 100 เครดิต',
        timestamp: '2023-10-24T10:15:00Z',
      },
      {
        id: 'l3',
        action: 'เล่นนิยายจบ',
        details: 'จบเรื่อง "วัตถุโบราณที่หายสาบสูญ" (ฉากจบ A)',
    ...
    storyProgress: [
      {
        ...
        progress: 100,
        status: 'จบแล้ว',
        lastPlayed: '2023-10-23T20:00:00Z',
      },
      {
        storyId: 's2',
        title: 'คืนนีออน',
        progress: 45,
        status: 'กำลังเล่น',
        lastPlayed: '2023-10-25T14:10:00Z',
      },
    ],
    achievements: [
    ...
    ratings: [
      {
        ...
        title: 'วัตถุโบราณที่หายสาบสูญ',
        rating: 5,
        comment: 'สนุกมากครับ เนื้อเรื่องเข้มข้น',
        createdAt: '2023-10-23T20:05:00Z',
      },
      {
        storyId: 's3',
        title: 'รักในโตเกียว',
    ...
    activityLogs: [
      {
        id: 'l1',
        action: 'เข้าสู่ระบบ',
        details: 'เข้าใช้งานแบบ Guest',
        timestamp: '2023-10-26T09:15:00Z',
      },
      {
        id: 'l2',
        action: 'เริ่มเล่น',
        details: 'เริ่มเรื่อง "วัตถุโบราณที่หายสาบสูญ"',
    ...
    storyProgress: [
      {
        ...
        progress: 15,
        status: 'กำลังเล่น',
        lastPlayed: '2023-10-26T09:45:00Z',
      },
    ],
    achievements: [],
    ratings: [],
  ...
  },
  {
    ...
    activityLogs: [
      { id: 'l1', action: 'ถูกระงับ', details: 'ละเมิดกฎชุมชน', timestamp: '2023-09-01T10:00:00Z' },
      {
        id: 'l2',
        action: 'รายงาน',
        details: 'ถูกผู้ใช้ report 5 ครั้ง',
        timestamp: '2023-08-31T23:00:00Z',
      },
    ],
    storyProgress: [],
    achievements: [],
  ...
  },
  {
    ...
    activityLogs: [
      {
        id: 'l4',
        action: 'ปลดล็อคความสำเร็จ',
        details: 'นักล่าสมบัติระดับตำนาน',
...
export const MOCK_STORIES: Story[] = [
  ...
  {
    id: 's6',
    title: 'ตำนานป่าหิมพานต์',
    description: 'การผจญภัยในโลกวรรณคดีไทย',
    genre: 'แฟนตาซี',
    status: StoryStatus.PUBLISHED,
    scenesCount: 30,
    totalEndings: 2,
    totalPlayers: 400,
    rating: 4.0,
    coverImage: 'https://picsum.photos/id/60/200/300',
    headerImage: 'https://picsum.photos/id/61/800/400',
    completionRate: 50,
    duration: '2 ชม.',
    tags: ['Thai', 'Fantasy'],
  },
  {
    ...
    description: 'ตามหาความจริงที่ซ่อนอยู่ในงานศิลปะ',
    genre: 'สืบสวน',
    status: StoryStatus.DRAFT,
    scenesCount: 10,
    totalEndings: 0,
    totalPlayers: 0,
    rating: 0,
    coverImage: 'https://picsum.photos/id/70/200/300',
    headerImage: 'https://picsum.photos/id/71/800/400',
    completionRate: 0,
    duration: 'TBD',
    tags: ['Mystery', 'Art'],
  },
...
export const MOCK_SCENES: Scene[] = [
  ...
  },
  {
    ...
    x: 400,
    y: 150,
    choices: [{ id: 'c3', text: 'จุดคบเพลิง', targetSceneId: 'sc4', cost: 1 }],
  },
  {
    id: 'sc3',
    storyId: 's1',
    ...
    x: 400,
    y: 450,
    choices: [{ id: 'c4', text: 'มุดเข้าไป', targetSceneId: 'sc4', cost: 0 }],
  },
  {
    id: 'sc4',
    storyId: 's1',
    ...
    endingDescription:
      'ชะตากรรมไม่ใช่สิ่งที่ถูกกำหนดไว้ล่วงหน้า แต่เป็นผลรวมของการกระทำเล็กๆ น้อยๆ ที่คุณเลือกในทุกช่วงลมหายใจ',
    x: 700,
    y: 300,
    choices: [],
  },
  ...
  },
  {
    ...
    x: 200,
    y: 500,
    choices: [{ id: 'c5', text: 'กลับไป', targetSceneId: 'sc1', cost: 0 }],
...
export const SYSTEM_LOGS = [
  {
    id: 1,
    type: 'error',
    message: 'Missing Image Asset: scene_104.jpg',
    time: '10:45 น.',
    location: 'บ้านร้างท้ายหมู่บ้าน',
  },
  {
    id: 2,
    type: 'warning',
    message: 'Translation missing for Choice #3',
    time: '09:20 น.',
    location: 'รักในโตเกียว',
  },
  {
    id: 3,
    type: 'error',
    message: 'Dead-end node detected',
    time: 'เมื่อวาน',
    location: 'คืนนีออน',
  },
...
export const MOCK_ADMIN_LOGS: AdminLog[] = [
  {
    id: 'al1',
    adminId: 'adm2',
    adminName: 'EditorJane',
    role: AdminRole.STORY_EDITOR,
    action: 'Edited Story',
    target: 'วัตถุโบราณที่หายสาบสูญ',
    timestamp: '2023-10-27T10:30:00Z',
    type: 'story',
  },
  {
    id: 'al2',
    adminId: 'adm3',
    adminName: 'SupportTom',
    role: AdminRole.USER_MANAGER,
    action: 'Adjusted Credits',
    target: 'User: story_lover_99 (+50)',
  ...
  },
  {
    ...
    target: 'Summer Event Winner',
    timestamp: '2023-10-20T10:50:00Z',
    type: 'system',
  },
];
