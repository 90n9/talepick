      ...
      <div className="relative w-full max-w-lg bg-[#1a1d26] border border-white/10 rounded-2xl shadow-2xl p-6 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
                <label className="text-sm font-bold text-gray-300 uppercase tracking-wider">หัวข้อการรายงาน</label>
            ...
            {/* Description */}
            <div>
                <label className="block text-sm font-bold text-gray-300 uppercase tracking-wider mb-2">รายละเอียดเพิ่มเติม</label>
                <textarea
                    value={description}
            ...
            <div className="flex gap-3 pt-2">
                ...
                >
                    {isLoading ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : 'ส่งรายงาน'}
                </button>
            </div>
        </form>
        ...
        <div className="mt-6 flex items-start gap-2 text-xs text-gray-500 bg-black/20 p-3 rounded-lg">
            ...
            <p>ทีมงานจะตรวจสอบรายงานของคุณภายใน 24 ชั่วโมง การรายงานเท็จอาจส่งผลให้บัญชีของคุณถูกระงับการใช้งาน</p>
        </div>
      </div>
    </div>
  );
