        ...
        <div className='bg-surface/30 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl space-y-12'>
          <section className='space-y-4'>
            ...
            <p className='text-gray-300 leading-relaxed'>
              ยินดีต้อนรับสู่ {APP_NAME} ("แพลตฟอร์ม") การเข้าถึงหรือใช้งานแพลตฟอร์มของเรา
          ...
          <section className='space-y-4'>
            ...
            <p className='text-gray-300 leading-relaxed'>
              {APP_NAME} ให้บริการในลักษณะ "ตามที่เป็นอยู่" (As is)
        ...
        <div className='mt-12 text-center'>
          <p className='text-gray-400'>
            ...
            <a
              ...
              className='text-primary hover:text-white transition-colors font-bold mt-2 inline-block'
            >
              legal@chronos.app
            </a>
          </p>
